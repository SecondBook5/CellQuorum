...
- :mod:`cellquorum.stages.comparative.differential_expression`
- :mod:`cellquorum.stages.comparative.differential_abundance`
- :mod:`cellquorum.stages.comparative.enrichment`
- :mod:`cellquorum.stages.comparative.multicellular_programs`
...
submodule imports: importing :mod:`cellquorum.stages.comparative` alone pulls in no heavy
