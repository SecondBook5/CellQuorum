...
Canonical location: :mod:`cellquorum.comparative.differential_expression.viz.volcano_viz`.
...
from cellquorum.comparative.differential_expression.viz.volcano_viz import (
    VolcanoVizMethod,
    load_de_table,
)
