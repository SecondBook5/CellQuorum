...
Canonical location: :mod:`cellquorum.comparative.differential_expression.viz.plots`.
...
from cellquorum.comparative.differential_expression.viz.plots import volcano
