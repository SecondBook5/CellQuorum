"""House-style figure saving for the CCC-visualization stage.

Creates parent directories and tags every produced figure ``kind="figure"``
(matching enrichment_viz; no refactor of other stages).
"""
