...
from cellquorum.stages.clustering.subclustering.extract import apply_group_filter, extract_focus
...
def test_extract_focus_subset_to_labels() -> None:
    ...
    from cellquorum.stages.clustering.subclustering.config import FocusConfig
